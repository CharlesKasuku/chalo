...
if ( isset($_POST['btn-signup']) ) {
     ...
     if (strlen($fname) < 3) {
			...
			$query = mysqli_query($conn,"INSERT INTO technicians(firstname,secondname,password) VALUES ('$fname','$sname','$pass')") or die(mysqli_error($conn)) ;
    ...
    <form method="post" action="" autocomplete="off">
    	...
    	<div class="col-lg-4" >
        	...
        	<div class="form-group">
            	...
            	<h2 class="well">register technicians below.</h2>
            ...
            <div class="form-group">
            	...
            	<button type="submit" class="btn btn-block btn-primary" name="btn-signup">Add technician</button>
