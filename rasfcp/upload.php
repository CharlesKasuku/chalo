<html>
 ...
 border-radius:5px;
    ...
    <fieldset><a href="adminportal.php"><span class="glyphicon glyphicon-home"></span>home</a><br><h2>Upload file</h2>
...
if ($filesize < 100 && $filesize< 1000000){
 ...
 if($errors==0){
  ...
  if($uplaod_success==TRUE){
   ...
   $result=mysqli_query($conn,"INSERT INTO uploads (note_name,note_size,note_type)VALUES('$name','$size','$type')") or die(mysqli_error($conn));
   if($result==TRUE){
